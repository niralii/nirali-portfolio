    ...
    <div className="page-wrapper" data-theme={theme}>
      ...
      <main className="project-detail-main">
        <div className="container">
          ...
          {/* --- TITLE HEADER --- */}
          <header>
            <h1>WanderAR: AR Education App</h1>
            <p className="subtitle"></p>
          </header>

          <div className="hero-image">
            <img 
              src="\wander_ar_logo.PNG" 
          ...
          <article className="content">
            <section className="description-section">
              <h2>Description</h2>
              <p>
                Developed a full-stack mobile application using React Native and AR to teach geography to school children.              </p>
            </section>
